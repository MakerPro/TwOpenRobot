...
private:
	...
	//! @brief メモリサイズ(byte)
	inline static const long SIZE()          { return 0x200L; }
	
	//! @brief I2Cネットワーク上での機器アドレス
	inline static const int  ADDRESS()       { return 0x50; }

	//! @brief 領域アドレス指定のバイト数
	inline static const int  ADDRESS_BYTES() { return 0; }
	
	//! @brief メモリチップの選択ビット
	inline static const int  SELECT_BIT()    { return 0; }

public:
	//! @brief 外部EEPROMの1チャンクの大きさ
	inline static const int CHUNK_SIZE() { return 16; }
